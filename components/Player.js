...
import { ArrowsRightLeftIcon, ForwardIcon, PauseIcon, PlayIcon, ArrowUturnLeftIcon, BackwardIcon, SpeakerWaveIcon, HeartIcon, } from '@heroicons/react/24/solid';
    ...
    return (
        <div className="h-24 bg-gradient-to-b from-black to-gray-500 text-white grid grid-cols-3 text-xs md:text-base px-2 md:px-8">
            ...
            <div className="flex items-center space-x-3 md:space-x-4 justify-end pr-5">
                ...
                <input className="w-14 md:w-28" type="range" value={volume} onChange={changeRange} min={0} max={100} />
